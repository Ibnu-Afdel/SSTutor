    ...
    <div class="space-y-6">
        ...
        <div class="relative flex items-start">
            ...
            <div class="ml-3 text-sm">
                ...
                <p class="text-gray-500">The course is only fot pro account users</p>
            </div>
        </div>

        <div>
            <label for="name" class="block mb-1 text-sm font-medium text-gray-700">Course Name <span
        ...
        <div>
            ...
            <div class="flex items-center mt-1 space-x-4">
                ...
                @if ($existingImageUrl && !$image)
                    {{-- Show existing only if no new temp image --}}
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
            ...
            <div>
                <label for="price" class="block mb-1 text-sm font-medium text-gray-700">Base Price ($) <span
                        class="text-red-500">*</span></label>
        ...
        <fieldset class="p-4 space-y-4 border border-gray-300 rounded-md">
            ...
            @if ($discount)
                <div class="grid grid-cols-1 pt-4 border-t border-gray-200 gap-y-6 gap-x-4 sm:grid-cols-2">
                    <div>
                        <label for="discount_type" class="block mb-1 text-sm font-medium text-gray-700">Discount Type
                    ...
                    <div>
                        <label for="discount_value" class="block mb-1 text-sm font-medium text-gray-700">Discount
                            Value
                            <span class="text-red-500">*</span></label>
                        <input type="number" wire:model.defer="discount_value" id="discount_value" step="0.01"
                            min="0" required
                            class="block w-full px-3 py-2 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
            ...
            <div>
                <label for="duration" class="block mb-1 text-sm font-medium text-gray-700">Duration (Hours) <span
                        class="text-red-500">*</span></label>
        ...
        {{-- Enrollment Limit --}}
        <div>
            <label for="enrollment_limit" class="block mb-1 text-sm font-medium text-gray-700">Enrollment Limit
                (Optional)</label>
        ...
        {{-- Requirements --}}
        <div>
            <label for="requirements" class="block mb-1 text-sm font-medium text-gray-700">Requirements
                (Optional)</label>
