...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-100">
            ...
            <div class="md:hidden" x-show="open" x-transition>
                <nav class="px-4 pt-2 pb-4 space-y-2 text-sm font-medium text-gray-700 bg-white border-t border-gray-200">
                    ...
                    @auth
                        ...
                        @elseif (auth()->user()->role === 'instructor')
                        <a href="{{ route('instructor.dashboard') }}" class="block hover:text-blue-500">Instructor Dashboard</a>
                        @elseif (auth()->user()->role === 'admin')
        ...
        <footer class="mt-12 text-white bg-gray-900">
            <div class="container flex flex-col items-center justify-between px-4 py-8 mx-auto space-y-4 text-center md:flex-row md:space-y-0 md:text-left">
                <p class="text-sm">
